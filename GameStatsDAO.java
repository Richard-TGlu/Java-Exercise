...
public class GameStatsDAO {
    ...
    public void addGameStats(GameStats gameStats) {
        String sql = "INSERT INTO GameStats (player_id, game_id, playing_time, points, assists, " + 
    ...
    public void updateGameStats(GameStats gameStats) {
        String sql = "UPDATE GameStats SET player_id = ?, game_id = ?, playing_time = ?, points = ?, assists = ?, " + 
    ...
    public ArrayList<GameStats> getGameStatsByGameAndTeam(int game_id, int team_id) {
        ...
        String sql = "SELECT gs.* FROM GameStats gs " +
